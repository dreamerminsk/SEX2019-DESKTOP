...
public class JListApp extends JFrame {
  ...
  private void init() {
    ...
    reload.addActionListener(
        (e) -> {
          Disposable d =
              Flowable.fromCallable(this::load)
      ...
      inner.addMouseMotionListener(
          new MouseMotionListener() {
            ...
            public void mouseMoved(MouseEvent e) {
              ...
              SubstanceColorScheme s =
                  SubstanceLookAndFeel.getCurrentSkin(comp)
                      .getEnabledColorScheme(SubstanceLookAndFeel.getDecorationType(comp));
